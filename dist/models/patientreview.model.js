...
const PatientReviewSchema = new mongoose_1.Schema({
...
const PatientReview = mongoose_1.default.model("PatientReview", PatientReviewSchema);
exports.default = PatientReview;
